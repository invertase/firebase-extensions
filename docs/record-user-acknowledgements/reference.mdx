...
Below contains an overview of the specifications for the Record User Acknowledgments extension, including TypeScript definitions & detailed descriptions.
...
export type GetNoticeResponse = Omit<NoticeDocument, ‘allowList’> & {
 ...
 // An ordered array of user acknowledgments.
