...
| Key         |                                Type                                | Optional | Min Value | Max Value | Default |
| ----------- | :----------------------------------------------------------------: | :------: | :-------: | :-------: | :-----: |
| colourspace | Enum([Colorspace](/storage-image-processing-api/types/colorspace)) |    x     |    n/a    |    n/a    |   n/a   |
...
rim "boring" pixels from all edges that contain values similar to the top-left pixel. Images consisting entirely of a single colour will calculate "boring" using the alpha channel, if any.
