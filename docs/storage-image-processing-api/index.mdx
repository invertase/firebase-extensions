...
Also, the last operation in the array must be an `output` operation. This operation specifies the properites of the image to be created. Read the [output](/output) operation documentation for more information.
