...
| Key   |         Type         | Optional | Min Value | Max Value | Default |
| ----- | :------------------: | :------: | :-------: | :-------: | :-----: |
| width | Enum([Colorspace]()) |    x     |    n/a    |    n/a    |   n/a   |
...
| blend         |  Enum[Blend]()  |    x     |    n/a    |    n/a    |   n/a   |
...
| Key                     |             Type              | Optional | Min Value | Max Value | Default |
| ----------------------- | :---------------------------: | :------: | :-------: | :-------: | :-----: |
| operationResizeFit      |   Enum(operationResizeFit)    |    x     |    n/a    |    n/a    |   n/a   |
| operationResizePosition | Enum(operationResizePosition) |    x     |    n/a    |    n/a    |   n/a   |
| operationResizeKernel   |  Enum(operationResizeKernel)  |    x     |    n/a    |    n/a    |   n/a   |
| OperationResizeKernel   |  Enum(OperationResizeKernel)  |    x     |    n/a    |    n/a    |   n/a   |
| OperationResizeStrategy | Enum(OperationResizeStrategy) |    x     |    n/a    |    n/a    |   n/a   |
...
| blend           |  Enums(blend)   |    ✓     |    n/a    |    n/a    |        0        |
| gravity         | Enums(gravity)  |    ✓     |    n/a    |    n/a    |       n/a       |
| top             |     Integer     |    ✓     |    n/a    |    n/a    |       n/a       |
| left            |     Integer     |    ✓     |    n/a    |    n/a    |       n/a       |
