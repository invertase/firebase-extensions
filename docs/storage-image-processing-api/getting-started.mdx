...
As a url can be broken down into the above sections. Each input, operation and output can contain multiple elements. This allows multipe transformation to be applied simulataneously.
