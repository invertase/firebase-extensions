...
export const acknowledgeNotice = functions.https.onCall(
  async (data, context) => {
    ...
    await eventChannel?.publish({
      type: `firebase.extensions.firestore-record-acknowledgements.v1.acknowledgement`,
      data: JSON.stringify({
        ...documentData,
        id: result.id,
      }),
...
export const unacknowledgeNotice = functions.https.onCall(
  async (data, context) => {
    ...
    await eventChannel?.publish({
      type: `firebase.extensions.firestore-record-acknowledgements.v1.unacknowledgement`,
      data: JSON.stringify({
        ...documentData,
        id: result.id,
      }),
