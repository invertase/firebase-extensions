...
describe('operations testing', () => {
  ...
  test('successfully creates a new image with a composite operation from a remote source', async () => {
  ...
  test('successfully creates a new image with a composite operation from a gcs source', async () => {
  ...
  test('successfully creates a new image with a composite operation from a created source', async () => {
